...
vim.keymap.set('n', '<leader>pe',
  '<cmd>lua vim.g.manual_prettier_autoformat_onsave = true<CR><cmd>lua print("manual auto-format with prettier is `enabled`")<CR>'
)
vim.keymap.set('n', '<leader>pd',
  '<cmd>lua vim.g.manual_prettier_autoformat_onsave = false<CR><cmd>lua print("manual auto-format with prettier is `disabled`")<CR>'
)
